...
class AddNoteFoodDialog: DialogFragment() {

    companion object {
        fun newInstance( onAddDrinkDialogButtonClicked: OnAddDrinkDialogButtonClicked): AddNoteFoodDialog {
            val dialog = AddNoteFoodDialog()
    ...
    private fun initView(view: View){
        ...
        spinnerTypeDrink!!.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, requireActivity().resources.getStringArray(R.array.type_food))
        setupRecyclerView()
        getDrinkFromType(spinnerTypeDrink!!.selectedItem.toString())
    }
    ...
    private fun getDrinkFromType(type: String){
        ...
        refFood.child(type).get().addOnCompleteListener { task ->
    ...
    private fun setAdapter() {
        ...
        adapterNote = AdapterNote(requireContext(), layoutInflater, listProducts, requireActivity(), AppConstants.FOOD_CHILD)
