...
import com.fjhidalgo.restaurante.module.ubic.outdoor.fragment.interactor.OutdoorInteractorImpl
import com.fjhidalgo.restaurante.module.ubic.outdoor.fragment.presenter.OutdoorPresenter
import com.fjhidalgo.restaurante.module.ubic.outdoor.fragment.presenter.OutdoorPresenterImpl

class OutdoorFragment: BaseFragment(), OutdoorView {

    val presenter: OutdoorPresenter<OutdoorView, OutdoorInteractor> by lazy {
        OutdoorPresenterImpl(OutdoorInteractorImpl(PreferenceHelperImpl(requireContext(), AppConstants.PREF_NAME), ApiHelperImpl()))
    }
    ...
    private fun initView(view: View){
        ...
        quitTable!!.setOnClickListener {
            ...
            if(tableList.size >= 1){
                presenter.deleteTableIndoor((tableList.size - 1).toString(), AppConstants.OUTDOOR)
            } else {
