package com.fjhidalgo.restaurante.module.menu.delete_product.viewholder
...
class DeleteProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(context: Context, item: ProductModel, position: Int, activity: AppCompatActivity) {
        ...
        imgButton.setOnClickListener {
            (activity as DeleteProductActivity).deleteProduct(item.id!!, item.linkImage!!, position)
        }
